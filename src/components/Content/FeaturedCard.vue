          ...
          <g-link :to="edge.node.path">
            <div class="h-full relative" :id="edge.node.id">
              ...
              <div class="featured-label absolute top-0 right-0 pr-10 pt-10 z-10">
                <span
                  class="p-2 relative block text-center text-xs leading-tight bg-white border border-gray-300 text-black rounded-full"
                >
                  <font-awesome :icon="['fas', 'star']" class="mr-1"></font-awesome>Featured
                </span>
              </div>
